...
public class AbstractExport {
    public void setAtributeHeader(HttpServletResponse response, String extendFile, String contentType, String prefix) throws IOException {
        DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss");
        String timestamp = dateFormat.format(new Date());
        String fileName = prefix + timestamp + extendFile;
...
//        createCell(row, 5, "Eanbled", cellStyle);
//
//    }
